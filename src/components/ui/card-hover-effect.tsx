  ...
  return (
    ...
    >
      <AnimatePresence>
        {hoveredIndex === idx && (
          <motion.span
            className="absolute inset-0 h-[550px] w-21 p-4 lg:gap-5 mx-6 bg-neutral-200 dark:bg-slate-800/[0.8] block rounded-3xl"
...
export const Card = ({
  ...
  >
    <div className="md:h-[300px] h-[150px] object-cover">
    <Image 
        src={imageSrc} 
        alt="Card image" 
